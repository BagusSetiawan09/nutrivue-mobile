  ...
  const renderStep2 = () => (
    <View className="flex-1 mt-6">
      ...
      <View className="items-center mt-4">
        <TextInput className="bg-white border border-gray-200 rounded-3xl w-full py-6 text-center text-4xl font-bold text-gray-900 tracking-[15px] shadow-sm" placeholder="0000" placeholderTextColor="#D1D5DB" keyboardType="numeric" maxLength={4} value={otp} onChangeText={setOtp} />
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} className="flex-1">
        <ScrollView 
          ...
          /* ⚡ JURUS PAMUNGKAS: paddingBottom 150 agar area tombol benar-benar bebas dari keyboard */
